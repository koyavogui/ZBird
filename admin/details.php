...
<header class="d-flex mt-2 container">
            ...
            <article class="ml-1 my-auto">
                ...
                <a href="../../" class="text-warning"><u>Deconnexion</u></a>
            </article>
        </header>
     ...
     <section class="d-flex text-warning">
     ...
     <section class="mt-3 container">
       ...
       <!-- footer-->
       <footer class="row bg-warning text-light mt-2" style="height :60px;"> Copyright</footer>
