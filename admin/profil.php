...
<?php
     ...
     <div class="mx-auto">
            <section class="container">
                <article class="my-2">
                <div class="mx-auto card mb-3 border-4  border-warning border-top-0 border-left-0 border-right-0 bg-light rounded-0 pb-2" style="max-width: 70%;">
                    ...
                    <div class="row container my-1">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="container-fluid btn btn-warning text-light">Modifier</button>
                        </div>
                    </div>
                </div>
                </article>
