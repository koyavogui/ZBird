$(document).ready(function(){
    ...
    $('#mic').click(function () { 
        const valeur = $('#micListen').hasClass("text-warning");
        let question ="";
        console.log(valeur);
        if (valeur) {
            $('#micListen').toggleClass("fa-microphone-alt text-warning fas fa-microphone-alt-slash text-danger");
            recognition.start()
            $('#micListen').attr('onclik', "recognition.start()");
            $('#micListen').removeAttr('onclik', "recognition.stop()");
        }else{
            $('#micListen').toggleClass("fas fa-microphone-alt text-warning fas fa-microphone-alt-slash text-danger");   
            recognition.stop()
