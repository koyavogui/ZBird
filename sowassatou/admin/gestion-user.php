        ...
        <div class="row" id="listUser">
            ...
            ?>
                ...
                <section class="d-flex  ">
                    <div class="mx-3 btn btn-warning text-light rounded-0" id="btnAdd">Ajouter un utilisateur</div>
                        ...
                        <tbody>
                            <?php foreach ($users as $user) {?>
                                <tr>
                                    ...
                                    <td class="">
                                        <span class="btn text-warning " data-toggle="modal" data-target="#editModal" data-id="<?php echo $user->idUser; ?>">
                ...
                <form class="m-2" id="editUserFom">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md mb-2">
                                <label class="text-warning font-weight-bold" for="fullNames" id="">Nom et prenoms : </label> <span id="editfullNames"></span>
                                <input type="hidden" name="fullname" value="" id="fullNameEdit">
                            </div>
                            <div class="col-md mb-2">
                            <label class="text-warning font-weight-bold" for="email">Email : </label> <span id="editemail"> </span>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-md col-sm ">
                                <label class="text-warning font-weight-bold" for="phone">Téléphone : </label> <span id="editphone"></span>
                                 
                            </div>
                            <div class="col-md-6">
                                <label class="text-warning" for="role">Rôles : </label>
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <h5 class="text-warning">Bloquer l’utilisateur :</h5>
                            </div>
