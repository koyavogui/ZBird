        ...
        <div class="modal-dialog modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" class="container" id="modalForm">
                    <div class="mb-3">
                        <label for="editQuestion" class="text-warning label-control">Les Questions: </label>
                        <textarea class="form-control border border-primary" id="editQuestion" name="editQuestion" rows="4"></textarea>
                    </div>
                        
                    <div class="mb-3">
                        <label for="editAnswers" class="text-warning label-control">Votre reponse : </label>
                    ...
                    <div class="mb-3 container   p-0">
                        <div class="row container-fluid m-0 p-0">
                            ...
                            <div class=" col-md-5 text-warning label-control"><p>Ou votre code d’intégration YouTube ci-dessous</p></div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" id="edit">Modifier</button>
            </div>
            </div>
        </div>
    </div>
     ...
     <div class="row col-md-7 mx-auto">
        <article class="col border border-warning my-3">
            <form enctype="multipart/form-data" class="container" id="intellectForm">
                ...
                ?>
                <div class="mb-3">
                    <label for="question" class="text-warning label-control">Les Questions: </label>
                ...
                <div class="mb-3">
                    <label for="answers" class="text-warning label-control">Votre reponse : </label>
                    <textarea class="form-control border border-primary" id="answers" name="answers" rows="2"></textarea>
                </div>
                <div class="mb-3 container   p-0">
                    <div class="row container-fluid m-0 p-0">
                        <input type="file" name="imageQuestion" id="imageQuestion" class="form-control-file  border border-warning col-md-7">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="" class="label-control text-warning">Ou votre code d’intégration YouTube ci-dessous</label>
                    <input type="text" name="youtube" id="youtube" class="form-control form-control-lg border border-primary">
                </div>
                <div class="mb-3 row" class="text-warning label-control">
                    <button type="submit" class="mx-auto col-md-6 btn btn-warning text-light">Valider</button>
                </div>
            </form>
        </article>
    </div>
       ...
       <!-- footer-->
    <footer class="bg-warning text-light  text-center  fixed-bottom" style="height :40px;"> Copyright@ Koya Michel</footer>
