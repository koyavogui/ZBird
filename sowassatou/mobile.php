    ...
    <section class="container-fluid position-absolute top-50 start-50 translate-middle">
        <section class="d-flex flex-column mt-5 align-items-center align-self-center ">
            ...
            <article class="btn" style="font-size: 3em;" id="mic">
                <i class="bi bi-mic text-warning" id="micListen"></i> 
</svg>
            </article>
        </section>
    </section>
...
// zoku.addCommands(commands);
    ...
    $(document).ready(function(){
        ...
        $('#mic').click(function () { 
            ...
            // console.log(valeur);
        if (valeur) {
            zoku.say("Poser moi une question, Je vous écoute.");
            $('#micListen').toggleClass("bi bi-mic text-warning   bi-stop-circle text-danger");
